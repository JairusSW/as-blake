...
// all charts move together. Ported from json-as/scripts/lib/palette.ts.
//
// Base palette:
...
// Engine/mode palette — one distinct hue per mode. Fastest mode (SIMD) gets the
// green. SWAR → strawberry red · SIMD → jungle green.
export const MODE_BARS = [
  { bg: rgba("strawberryRed", 0.85), border: BASE.strawberryRed }, // SWAR
  { bg: rgba("jungleGreen", 0.85), border: BASE.jungleGreen }, // SIMD
];
